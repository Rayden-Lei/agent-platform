...
['FR-010','文档处理','P0','按文件类型差异化分片(文本/Markdown/PDF/Word/表格/图片OCR)，智谱 embedding-3 向量化'],
['FR-011','检索增强','P0','混合召回(向量+关键词)加权融合重排 + 引用回填'],
['FR-012','工作流编排','P0','React Flow 拖拽，8 类节点(含知识库检索/代码执行/HTTP请求)'],
